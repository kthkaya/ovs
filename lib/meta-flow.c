...
mf_is_all_wild(const struct mf_field *mf, const struct flow_wildcards *wc)
{
    ...
    case MFF_TRH_NEXTUID:
		return !wc->masks.ip6trh_nextuid;
             ...
             union mf_value *value)
{
    ...
    case MFF_NSH_C4:
        ...
        break;
    case MFF_TRH_NEXTUID:
       	value->be32 = flow->ip6trh_nextuid;
       	break;
             ...
             const union mf_value *value, struct match *match, char **err_str)
{
    ...
    case MFF_NSH_C4:
        ...
        break;
    case MFF_TRH_NEXTUID:
       	MATCH_SET_FIELD_BE32(match, ip6trh_nextuid, value->be32);
       	break;
                  ...
                  const union mf_value *value, struct flow *flow)
{
    ...
    case MFF_NSH_C4:
        ...
        break;
    case MFF_TRH_NEXTUID:
       	flow->ip6trh_nextuid = value->be32;
       	break;
...
mf_set_wild(const struct mf_field *mf, struct match *match, char **err_str)
{
    ...
    case MFF_NSH_C4:
        ...
        break;
    case MFF_TRH_NEXTUID:
    	match_set_ipv6_trh_masked(match,htonl(0), htonl(0));
		break;
       ...
       struct match *match, char **err_str)
{
    ...
    case MFF_NSH_C4:
        ...
        break;
    case MFF_TRH_NEXTUID:
    	match_set_ipv6_trh_masked(match, value->be32, mask->be32);
    	break;
